...
Class.register('org.korsakow.controller.MainController', org.korsakow.controller.AbstractController, {
    ...
    setup: function($super, env) {
        ...
        this.shareButtonClickHandler = function() {
            shareTemplate.show();
...
Class.register('org.korsakow.controller.maincontroller.ExecuteSnu', {
    ...
    setupShareButton: function(env) {
        ...
        this.mainController.shareButton.unbind();
        // seems like a call to unbind on the mainController is recursive
        // a proper solution might be to make sure all bind/unbinds are namespaced
        this.mainController.shareButton.click(this.mainController.shareButtonClickHandler);
    }
});
